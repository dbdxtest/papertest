...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='f10cd679eb5f5805cb6bdf1fabc19d918affac80'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'HEAD -> master, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/108260/rebase, refs/__gh__/pull/103911/rebase' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'HEAD -> master, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/108260/rebase, refs/__gh__/pull/103911/rebase' =~ tag:\ (v[^ ,]+) ]]; then
